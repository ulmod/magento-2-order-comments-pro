...
[Magento 2 Order Comments Pro](https://www.ulmod.com/ordernotes-for-magento-2.html)  is a Magento 2 extension that allows your buyers to leave comments on their orders before and after checkout and receive admins' replies via email and under their account at the storefront.

With Magento 2 Order Comments Pro, you can build a great communication with your buyers regarding their orders. Buyers can leave a comment during the checkout, and once the order is placed, buyers can add additional comments to the order from their account in frontend and receives admins reply

<a href="https://www.ulmod.com/ordernotes-for-magento-2.html"><img width="205" src="https://www.ulmod.com/media/wysiwyg/um-download-now1.png"></a>

## Key Features

* Buyers can leave order comments during the checkout process
* Buyers can add additionals comments to the order after the checkout, and reply to the admin's message from their account in the frontend
* Admins can add additionals comments to the order from the admin panel
* Admins can reply to any buyer's comments from the admin panel
* Admins can choose to notify the buyer by email when any new comment is added to the order from the admin panel
* Admins can choose to show/hide each comment under my buyer account page in the frontend
* Admins can edit or delete each order comment from the backend
* Ability to insert order comments on email template to display on order confirmation emails
* Ability to notify both buyers and admins when any additional comment is added to the order
* Mobile-friendly
* Support multiple-stores


<img src="https://www.ulmod.com/media/ulmod/product_content/order-n-p-main.png">
<img src="https://www.ulmod.com/media/ulmod/product_content/order-n-p-admin.png">
